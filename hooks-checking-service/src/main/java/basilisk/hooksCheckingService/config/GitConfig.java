...
public class GitConfig {
    ...
    @Bean
    public GitCheckingServiceFactory gitCheckingServiceFactory(GitRepoRepository gitRepoRepository, GitHookRepository gitHookRepository, HookMessageSender hookMessageSender)
    {
